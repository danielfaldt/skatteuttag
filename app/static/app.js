...
const TRANSLATIONS = {
  sv: {
    ...
    "info.company_result_before_corporate_tax": "Det här är bolagets resultat före bolagsskatt. I årsredovisningen motsvarar det normalt raden resultat före skatt eller resultat efter finansiella poster i resultaträkningen. Har du bokföringen nära till hands kan du också ta det från en aktuell resultatrapport.",
    "info.opening_retained_earnings": "Det här är fria vinstmedel från tidigare år som redan får delas ut. I årsredovisningen hittar du det normalt i balansräkningen eller i noten/förändringen för eget kapital, ofta som balanserad vinst eller fritt eget kapital vid årets början.",
  ...
  en: {
    ...
    "info.company_result_before_corporate_tax": "This is the company's result before corporate tax. In annual accounts it usually matches profit before tax or profit after financial items in the income statement. If you have bookkeeping available, you can also take it from a current profit report.",
    "info.opening_retained_earnings": "This is distributable retained profit from earlier years. In annual accounts you usually find it in the balance sheet or in the equity note/change in equity, often labelled retained earnings or unrestricted equity at the start of the year.",
